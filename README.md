...
```
┌─────────────────────────────────────────────────────────────────────────────┐
│                          USER INPUT: Stock Symbol (e.g., NVDA)              │
└──────────────────────────────────┬──────────────────────────────────────────┘
                                   │
                                   ▼
┌─────────────────────────────────────────────────────────────────────────────┐
...
├─────────────────────────────────────────────────────────────────────────────┤
│  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐  ┌──────────────┐   │
│  │ Google       │  │ StockAnalysis│  │ Financial    │  │ News Sources │   │
│  │ Finance      │  │ .com         │  │ Statements   │  │ (15+ sites)  │   │
│  │              │  │              │  │              │  │              │   │
│  │ • Price      │  │ • Historical │  │ • Income     │  │ • CNBC       │   │
│  │ • Market Cap │  │ • OHLC Data  │  │ • Balance    │  │ • Reuters    │   │
│  │ • P/E Ratio  │  │ • Forecasts  │  │ • Ratios     │  │ • Bloomberg  │   │
│  └──────────────┘  └──────────────┘  └──────────────┘  └──────────────┘   │
└──────────────────────────────────┬──────────────────────────────────────────┘
                                   │
                                   ▼
┌─────────────────────────────────────────────────────────────────────────────┐
│                    AI AGENT LAYER (11 Specialized Agents)                   │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  ┌─────────────────────── DATA ANALYSIS AGENTS ──────────────────────────┐ │
│  │                                                                        │ │
│  │  🔧 Agent 1: Technical Analysis        🔧 Agent 2: Fundamental        │ │
│  │  • SMA, EMA, RSI, MACD                 • P/E, ROE, Growth Rates       │ │
│  │  • Bollinger Bands                     • Quality Scores               │ │
│  │  • LLM-powered calculations            • Financial Health             │ │
│  │                                                                        │ │
│  │  🏢 Agent 3: Company Name                                             │ │
│  │  • Official name identification                                       │ │
│  │  • Domain discovery for logo                                          │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
│  ┌─────────────────────── RISK ASSESSMENT AGENTS ────────────────────────┐ │
│  │                                                                        │ │
│  │  🚨 Agent 4: Fraud Detection (Math)    🚨 Agent 5: Fraud Analysis     │ │
│  │  • Volume Spike Ratio (TVR)            • LLM interpretation           │ │
│  │  • Abnormal Returns (AR)               • News context analysis        │ │
│  │  • Cumulative Patterns (CAR)           • Catalyst identification      │ │
│  │  • Pattern detection                   • Risk assessment (Temp 0.3)   │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
│  ┌─────────────────────── SUMMARY & INSIGHTS AGENTS ─────────────────────┐ │
│  │                                                                        │ │
│  │  📝 Agent 6: Summary (200 tokens)      📊 Agent 7: Executive Summary  │ │
│  │  • 2-3 sentence overview               • 800 tokens, 8-12 sentences   │ │
│  │                                                                        │ │
│  │  📈 Agent 8: Detailed Analysis         💰 Agent 9: Investment Recs    │ │
│  │  • 1500 tokens deep dive               • 2000 tokens                  │ │
│  │  • Week-by-week breakdown              • 3 time horizons              │ │
│  │  • News impact assessment              • Short/Medium/Long term       │ │
│  │                                                                        │ │
│  │  👥 Agent 10: Analyst Synthesis        🧠 Agent 11: Meta-Analysis     │ │
│  │  • 1500 tokens                         • 2000 tokens                  │ │
│  │  • Consensus ratings                   • AI-powered synthesis         │ │
│  │  • Price target analysis               • Cross-validation             │ │
│  └────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
│  ┌──────────────────────── ORCHESTRATOR ─────────────────────────────────┐ │
│  │  🎼 Multi-Agent Orchestrator                                          │ │
│  │  • Coordinates all 6 summary agents                                   │ │
│  │  • Shares prepared data for consistency                               │ │
...
│  │  • Company logo      │           │  • Formatted analysis        │       │
│  │  • All agent outputs │           │  • Agent deployment status   │       │
│  │  • Color-coded       │           │  • Real-time progress        │       │
│  │  • Professional      │           │  • Summary sections          │       │
│  └──────────────────────┘           └──────────────────────────────┘       │
└─────────────────────────────────────────────────────────────────────────────┘

Total LLM Calls per Analysis: 10+ (depending on data availability)
Agent Collaboration: Sequential execution with shared data context
Temperature Settings: 0.3 (fraud analysis), default (other agents)
```
